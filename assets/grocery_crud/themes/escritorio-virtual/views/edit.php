...
//CONFIGURAÇÕES
$this->set_js($this->default_theme_path.'/escritorio-virtual/js/app/twitter-bootstrap-edit.js');
?>
    ...
    <div id="defaultPortlet" class="panel-collapse collapse in">
        <div class="portlet-body">
            ...
            <div id="message-box" class="span12"></div>
                <?php
                echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data" role="form"');
