...
/* Translated by rafael84 */
	...
	$lang['form_update_loading'] 	= 'Aplicando alterações...';
	...
	$lang['error_on_uploading'] 	= "Ocorreu um erro ao enviar o arquivo.";
	$lang['message_prompt_delete_file'] 	= "Tem certeza de que deseja excluir este arquivo?";
	
	$lang['error_max_number_of_files'] 	= "Você pode enviar apenas um arquivo por vez.";
	$lang['error_accept_file_types'] 	= "Você não tem permissão de enviar arquivos com esta extensão.";
	$lang['error_max_file_size'] 		= "O upload do arquivo excede a diretiva que foi especificada {max_file_size}.";
