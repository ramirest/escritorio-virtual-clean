...
class Oauth_server
{
	...
	public function validate_user($username = '', $password = '')
	{
        ...
        $this->ci->load->model('modelassociados', 'mass');

        if($this->ci->dx_auth->login($username, $password, FALSE)):
            $dados = $this->ci->mass->getAssociado($this->ci->dx_auth->get_associado_id(), '', '', '', 'aid, Nome, Email');
