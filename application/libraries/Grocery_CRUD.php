...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	public function set_css($css_file, $base = TRUE)
	{
        $url = $base===TRUE?base_url():'';
		$this->css_files[sha1($css_file)] = $url.$css_file;
	}

	public function set_js($js_file, $base = TRUE)
	{
        $url = $base===TRUE?base_url():'';
		$this->js_files[sha1($js_file)] = $url.$js_file;
	}
	...
	protected function get_true_false_input($field_info,$value)
	{
		...
		$input .= "<div class='radio'><label><input id='field-{$field_info->name}-true' type='radio' name='{$field_info->name}' value='1' $checked /> ".$true_string."</label></div> ";
		...
		$input .= "<div class='radio'><label><input id='field-{$field_info->name}-false' type='radio' name='{$field_info->name}' value='0' $checked /> ".$false_string."</label></div>";
	...
	protected function get_dropdown_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='form-control' data-placeholder='".$select_title."'>";
	...
	protected function get_set_input($field_info,$value)
	{
		...
		$select_title = str_replace('{field_display_as}',$field_info->display_as,$this->l('set_relation_title'));
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}[]' multiple='multiple' size='8' class='form-control' data-placeholder='$select_title' style='width:510px;' >";
