...
<form id="edita-pagina" name="edita-pagina" method="post" action="<?php echo site_url("adm/paginas/editar/".$pag->pid) ?>">
<table class="listing form">
    <tr>
      <td>T&iacute;tulo</td>
      <td><?php echo form_input(array('name'=>'titulo', 'id'=>'titulo', 'size'=>83), set_value('titulo', $pag->titulo)); ?></td>
    </tr>
    <tr>
      <td>Corpo</td>
      <td><?php echo form_textarea(array('name'=>'corpo', 'id'=>'corpo', "cols"=>80,"rows"=>10), set_value('titulo', $pag->corpo)); ?></td>
    </tr>
</table>
<button id="editar-pagina" class="ui-button ui-state-default ui-corner-all">Editar P&aacute;gina</button>
</form>
</body>
</html>