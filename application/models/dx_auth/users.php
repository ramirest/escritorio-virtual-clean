...
class Users extends CI_Model 
{
	function __construct()
	{
		...
		$this->_associados = $this->_prefix.$this->config->item('DX_associados_table');	
	...
	{
		$users_table = $this->_table;
		$associados_table = $this->_associados;
		if($login != 'xadmin'):
			$this->db->select("$users_table.*", FALSE);
			$this->db->select("$associados_table.aid AS associado", FALSE);
			$this->db->join($associados_table, "$associados_table.aid = $users_table.aid");
		endif;
